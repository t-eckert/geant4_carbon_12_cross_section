...
class LTAC1DetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  private:
	 ...
	 //Acrylic Holder
	 G4double AcHInnerRadius;
	 G4double AcHOuterRadius;
	 G4double AcHHalfHeight;
	 G4double AcHOffset;

	 //Epoxy Plug
	 G4double EPOuterRadius;
	 G4double EPHalfHeight;
	 G4double EPOffset;
	...
	G4LogicalVolume* AcH_log;
	G4LogicalVolume* EP_log;
	...
	G4VPhysicalVolume* AcH_phys;
	G4VPhysicalVolume* EP_phys;
