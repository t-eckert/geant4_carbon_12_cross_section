...
{ 
	 ...
	 //Aluminum Ring
	 AlInnerRadius = 2.50*cm/2;
	 AlOuterRadius = 2.70*cm/2;
	 AlThickness = 0.318*cm;
...
//
 ...
 //===============BEGIN=Aluminum Ring========================//
   ...
   G4Tubs *Ring = new G4Tubs("Ring", AlInnerRadius, AlOuterRadius, AlThickness, 0.0, 360.*deg);
   Ring_log = new G4LogicalVolume(Ring, Al, "Ring_log", 0, 0, 0);
   Ring_phys = new G4PVPlacement(0, G4ThreeVector(0.0, 0.0, 0.318*cm), Ring_log, "Ring", Room_log, false, 0);
   G4VisAttributes Ring_Att(G4Color::Blue());
 ...
 z_pos = 0-z_pos;
 //NaI2Wall_phys = new G4PVPlacement(0, G4ThreeVector(x_pos, y_pos, z_pos), NaI2Wall_log, "Na2Wall", Room_log, false, 0);
